  ...
  return (
    <main className="bg-brand-black min-h-screen">
      ...
      <section className="relative overflow-hidden">
        <div aria-hidden className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(22,163,74,0.12),transparent_55%)]" />
        <div className="relative max-w-5xl mx-auto px-6 md:px-10 py-16 md:py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-2xl mx-auto">
            <Link
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 bg-brand-green hover:bg-brand-green-hover text-brand-black font-bold px-6 py-4 rounded-xl text-base transition-colors"
            >
              Abrir en GitHub →
            </Link>
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 inline-flex items-center justify-center gap-2 text-brand-green hover:text-white font-semibold px-6 py-4 rounded-xl text-base border border-brand-green/40 hover:border-brand-green transition-colors"
            >
              Guía de instalación
            </Link>
          </div>
      ...
      {/* BONUS: Priority call */}
      {hasPriority ? (
        <section className="py-12 border-y border-brand-green/30 bg-gradient-to-br from-brand-green/10 via-transparent to-transparent">
          <div className="max-w-4xl mx-auto px-6 md:px-10 text-center">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-brand-green hover:bg-brand-green-hover text-brand-black font-bold px-8 py-4 rounded-xl text-base transition-colors"
            >
            ...
            {STEPS.map((s, i) => (
              <article key={s.title} className="flex gap-4 p-5 rounded-2xl border border-white/10 bg-black/40">
                ...
                <div className="flex-1">
                  ...
                  {s.code ? (
                    <code className="block font-mono text-xs text-brand-green bg-black/60 border border-white/10 rounded px-3 py-2">
                      {s.code}
                    </code>
                  ) : null}
                </div>
