...
export const signatureGradient = {
  css: "linear-gradient(90deg, #00D64F 0%, #00D64F 50%, #00D64F 100%)",
  description:
...
export const usageProportions = [
  { name: "Yellow", value: 460, color: "#00D64F" },
  { name: "Gray", value: 357, color: "#A3A3A3" },
  { name: "Gold", value: 270, color: "#00D64F" },
  { name: "Black", value: 114, color: "#000000" },
  { name: "Graphite", value: 84, color: "#262626" },
];
