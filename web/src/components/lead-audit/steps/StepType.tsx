    ...
    <div className="flex flex-col items-center text-center">
      ...
      >
        ...
        <p className="text-sm text-brand-gray/70 max-w-md mb-4">
          ...
          <span className="text-brand-green font-semibold">30% de descuento</span> en tu primer mes de partnership.
        </p>
        <div className="flex flex-col gap-1.5 mb-6 text-left max-w-sm">
          <div className="flex items-center gap-2 text-xs text-brand-gray">
            <span className="w-4 h-4 rounded-full bg-brand-green/15 flex items-center justify-center text-[10px] text-brand-green font-bold">1</span>
            Análisis con IA de tu marca — insights accionables
          </div>
          <div className="flex items-center gap-2 text-xs text-brand-gray">
            <span className="w-4 h-4 rounded-full bg-brand-green/15 flex items-center justify-center text-[10px] text-brand-green font-bold">2</span>
            Llamada de 30 min con un estratega — solo si tu marca encaja
          </div>
          <div className="flex items-center gap-2 text-xs text-brand-gray">
            <span className="w-4 h-4 rounded-full bg-brand-green/15 flex items-center justify-center text-[10px] text-brand-green font-bold">3</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
        <motion.button
          ...
          className="group relative flex flex-col items-center gap-4 p-6 rounded-2xl border border-white/10 bg-white/[0.03] text-left transition-all hover:border-brand-green/40 hover:bg-brand-green/[0.04] hover:shadow-[0_0_30px_rgba(22,163,74,0.1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green"
          ...
          whileTap={{ scale: 0.98 }}
        >
          <div className="w-14 h-14 rounded-xl bg-brand-green/10 border border-brand-green/20 flex items-center justify-center transition-colors group-hover:bg-brand-green/20">
        ...
        >
          <div className="w-14 h-14 rounded-xl bg-brand-green/10 border border-brand-green/20 flex items-center justify-center transition-colors group-hover:bg-brand-green/20">
            <Camera className="w-7 h-7 text-brand-green" />
          </div>
          <div className="text-center">
