...
export function RegistrationForm() {
  ...
  if (success) {
    return (
      <div className="w-full max-w-md mx-auto rounded-2xl p-8 text-center bg-brand-graphite/40 backdrop-blur-md border border-brand-green/30 shadow-[0_0_60px_rgba(22,163,74,0.18)] animate-fade-in">
        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-brand-green/15 flex items-center justify-center">
        ...
        <a
          ...
          className="block w-full py-3 rounded-lg font-sans font-bold text-sm tracking-wide bg-brand-green text-white hover:bg-brand-green-dark transition-colors shadow-[0_0_20px_rgba(22,163,74,0.45)]"
        >
          Ingresar a KREOON →
        </a>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
        ...
        <div>
          ...
          <div className="flex gap-2">
            <div className="flex items-center gap-1.5 px-3 bg-black/60 border border-brand-green/30 rounded-lg text-sm text-white font-sans">
              <span>+57</span>
            </div>
        ...
        <div>
          <label className="flex items-start gap-3 cursor-pointer group">
            <input
              ...
              className="mt-0.5 w-4 h-4 accent-brand-green cursor-pointer flex-shrink-0"
            />
            <span className="text-xs text-brand-gray font-sans leading-relaxed group-hover:text-white">
              Soy mayor de 18 anos y acepto los{" "}
              <a href="https://kreoon.com/terms" target="_blank" rel="noopener noreferrer" className="text-brand-green hover:underline">
                Terminos
              </a>
              ,{" "}
              <a href="https://kreoon.com/privacy" target="_blank" rel="noopener noreferrer" className="text-brand-green hover:underline">
                Privacidad
              </a>{" "}
              y Ley 1581
            </span>
