  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: reverse
            ? "radial-gradient(ellipse 50% 60% at 90% 50%, rgba(22,163,74,0.07) 0%, transparent 70%)"
            : "radial-gradient(ellipse 50% 60% at 10% 50%, rgba(22,163,74,0.07) 0%, transparent 70%)",
        }}
      />
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        >
          ...
          {/* Deliverables */}
          <div className="mb-6">
            <p className="flex items-center gap-2 text-[11px] font-sans font-bold tracking-widest uppercase text-brand-green mb-3">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            ...
            <div className="p-4 rounded-xl border border-brand-green/40 bg-brand-green/5">
              ...
              <p className="text-sm text-brand-green font-sans font-bold leading-relaxed">{priceRange}</p>
            </div>
          </div>
