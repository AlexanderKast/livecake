...
interface AvatarCTAFinalProps {
  headline?: React.ReactNode;
  subHead?: string;
}

export function AvatarCTAFinal({
  headline = (
    <>
      20 minutos.{" "}
      <span
  ...
  subHead = "Sin compromiso. En 20 minutos de diagnóstico te mostramos el guión del live, el stack de Pancake que usarías y la proyección de conversión estimada para tu producto.",
}: AvatarCTAFinalProps) {
  return (
    <section
      id="cta"
      aria-labelledby="cta-avatar-heading"
