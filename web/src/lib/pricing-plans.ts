...
export const PLAN_INCLUDES_ALL: string[] = [
  "Suite Pancake: WebCake + LiveCake + Botcake + CRM + Postcake",
  "Conversion API nativa (Meta + TikTok + Google)",
  "1 integración de plataforma (Hotmart, Dropi, Hoco o Gintracom)",
  "Pancake 4 conexiones activas",
  "1 dominio WebCake incluido",
  "6 videos para ads (producción básica)",
  "1 spot base genérico",
];
